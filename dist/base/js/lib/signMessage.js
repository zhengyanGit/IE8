                ...
                try{
                    ...
                    if (e instanceof TCACErr) {
                        return M.ui.status.init({
                            position: 'fixed',
                            html: '没有检测到证书助手，请下载并安装证书助手！<a class="g-block g-text-center" download="" href="'+ $.interfacePath.server+'demo/template/res/data/eastpaytools.exe' +'">点击此处下载<a/>',
                            callback: function() {
                        ...
                        return M.ui.status.init({
                            position: 'fixed',
                            html: '请插入u-key并安装驱动程序<a class="g-block g-text-center" download="" href="'+ $.interfacePath.server+'demo/template/res/data/eastpaydrive.zip' +'">点击此处下载<a/>',
                            callback: function() {
                                console.log('callback')
                            },
                            close: function () {
